    ...
    public static class Kms
    {
        ...
        public static string StatusMessage(uint hResult)  //BUGBUG: Better read %SystemDrive%\System32\slmgr\<localization dir>\slmgr.ini to get error messages (even though this file is awfully buggy).
        {
            switch (hResult)
            {
                ...
                case 0x4004FC04: return "The application is running within the timebased validity period.";
                ...
                default:
                    ...
                    {
                        return "Unknown error. Try running \"slui 42 0x" +
                             hResult.ToString("X") + "\" in a command prompt (CMD.EXE) to display a more descriptive error text.";
                    }
            }
        }
