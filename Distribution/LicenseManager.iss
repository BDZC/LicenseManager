...
Source: "OpenVPN\tap-windows-9.21.2.exe"; DestDir: "{tmp}"; Components: "vpn"
...
Filename: "{tmp}\tap-windows-9.21.2.exe"; Description:"Install TAP adapter"; WorkingDir: "{tmp}"; Parameters: "/S";  StatusMsg: "Installing OpenVPN TAP Adapter ..."; BeforeInstall: SetMarqueeProgress(True); Tasks: "vpnsilent"; Components:"vpn";
Filename: "{tmp}\tap-windows-9.21.2.exe"; Description:"Install TAP adapter"; WorkingDir: "{tmp}"; StatusMsg: "Installing OpenVPN TAP Adapter ..."; BeforeInstall: SetMarqueeProgress(True); Tasks: "not vpnsilent"; Components:"vpn";
